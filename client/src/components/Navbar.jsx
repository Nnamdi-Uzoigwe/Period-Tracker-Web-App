...
export default function Navbar() {
    return (
        <div className="fixed top-0 left-0 w-full bg-white opacity-95 py-4 lg:py-6 px-8 lg:px-40 flex z-50 justify-between items-center border-b-[2px] border-gray-300">
